            ...
            <div id="job_item_business_container">
                <div id="job_item_business" >
                    <div id="job_item_logo_business_container">
                        <img id="job_item_business_logo" src={this.state.job_logo} alt="job_logo"/>
                    </div>

                    <div id="job_item_info_business">
                        <div class="full_info_business">
                            <b> תחום כללי של העבודה: </b>{this.state.job_type}<br />
                            <b> מתי: </b>{this.state.job_date} , {this.state.job_hours}<br />
                            <b> איפה: </b>{this.state.job_place}<br/>
                            <b> משכורת: </b>{this.state.job_salary}₪<br/>
                            <b>פרטים נוספים:</b>{this.state.job_long_info}<br/>
                            <b>ביגוד: </b>{this.state.job_clothing}<br/>
                            <b>זמן תשלום : </b>{this.state.job_payment_time}<br/>
                        ...
                        <div id="job_item_buttons_delete_job" onClick={() => this.props.deleteJob(this.state.job_index)}>
                            מחק משרה
                        </div>
                    </div>
                    </div>
