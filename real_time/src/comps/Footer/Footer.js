...
class Footer extends Component{
    render(){
        return(
            <div id = "footer">
                <a href="https://www.facebook.com/זמן-אמת-Zman-Emet-101856524893149/" target="_blank" rel="noopener noreferrer">
                <img id = "facebook_icon" className = "social_media_buttons" src = {facebook_icon} alt = "facebook" />
                </a>
                <a href="https://www.instagram.com/zmanemet_jobs/" target="_blank" rel="noopener noreferrer">
